/**
 * Full variant of Kind 0 specialized component for displaying user metadata
 ...
 */
const FullKind0Component: Component<{ event: NostrEvent }> = (props) => {
...
export default FullKind0Component; 